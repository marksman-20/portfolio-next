...
export default function SustainableFinanceBlog() {
  return (
    <BlogShell
      ...
      hero="/images/extracted/finance_page5_4.jpeg"
      toc={toc}
      doc="/assets/2022-5IPM-37_Manas_Pokley.pdf"
    ...
    >
      ...
      <section id="policy">
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/finance_page5_2.jpeg"
      ...
      <section id="litigation">
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/finance_page5_3.jpeg"
      ...
      <section id="evidence">
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/finance_page5_5.jpeg"
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/finance_page5_6.jpeg"
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/finance_page5_7.jpeg"
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/finance_page5_8.jpeg"
      ...
      <section id="stats">
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/finance_page7_1.png"
