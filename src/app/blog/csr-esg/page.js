...
export default function CSRESGBlog() {
  return (
    <BlogShell
      ...
      hero="/images/extracted/csr_page8_1.png"
      toc={toc}
      doc="/assets/BEV.pdf"
    ...
    >
      ...
      <section id="spend">
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/csr_page4_1.png"
      ...
      <section id="environment">
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/csr_page6_1.png"
      ...
      <section id="social">
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/csr_page8_1.png"
      ...
      <section id="governance">
        ...
        <figure className={styles.figure}>
          <Image
            src="/images/extracted/csr_page10_1.png"
